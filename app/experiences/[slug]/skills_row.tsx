      ...
      {skills.map((skill) => {
        return (
          <Link key={skill.id} href={`/skills/${skill.id}`}>
            <Card
              className='flex cursor-pointer items-center gap-2 bg-white p-2 text-sm font-semibold accent-violet-400 shadow-lg transition-shadow duration-200 ease-in-out hover:shadow-xl focus:ring-2 focus:ring-offset-2 active:outline-none'
