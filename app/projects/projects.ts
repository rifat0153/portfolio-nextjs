...
export const softwareProjects: Project[] = [
  ...
  },
  {
    ...
    description: `At Senceive, I built several internal dashboards leveraging cutting-edge technologies like Vue3, Nuxt 3, and .Net Core. 
      These dashboards were not only visually appealing but also provided a comprehensive and intuitive interface for users to interact with and explore data. 
      By integrating ChartJS, I designed intricate and informative charts, enabling users to visualize complex datasets easily. 
      This initiative was a testament to my capabilities in full-stack development, delivering robust solutions that catered to the needs of both clients and end-users.`,
    link: {
      type: 'internal',
      url: '/experiences/senceive',
    },
  ...
  },
  {
    ...
    link: {
      type: 'external',
      url: 'https://play.google.com/store/apps/details?id=co.uk.wotspot.indigo.ios.stage&hl=en_US&gl=US',
    },
